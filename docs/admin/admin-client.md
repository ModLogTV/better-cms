...
- [Namespaces](#namespaces)
  - [`admin.namespaces.list()`](#adminnamespaceslist)
  - [`admin.namespaces.describe({ namespace })`](#adminnamespacesdescribe-namespace)
  - [`admin.namespaces.getTranslations({ namespace, locale })`](#adminnamespacesgettranslations-namespace-locale)
  - [`admin.namespaces.updateTranslation({ namespace, locale, key, value })`](#adminnamespacesupdatetranslation-namespace-locale-key-value)
- [Pages](#pages)
  - [`admin.pages.list()`](#adminpageslist)
  - [`admin.pages.get({ slug, locale, draft })`](#adminpagesget-slug-locale-draft)
  - [`admin.pages.update({ id, blocks })`](#adminpagesupdate-id-blocks)
  - [`admin.pages.publish({ id })`](#adminpagespublish-id)
- [Media](#media)
  ...
  - [`admin.media.presign({ filename, mimeType, size })`](#adminmediapresign-filename-mimetype-size)
- [Locales](#locales)
  - [`admin.locales.list()`](#adminlocaleslist)
  - [`admin.locales.upsert({ code, name, isDefault })`](#adminlocalesupsert-code-name-isdefault)
  - [`admin.locales.delete({ code })`](#adminlocalesdelete-code)
- [Users](#users)
  - [`admin.users.list()`](#adminuserslist)
  - [`admin.users.getPermissions({ userId })`](#adminusersgetpermissions-userid)
  - [`admin.users.setPermissions({ userId, permissions })`](#adminuserssetpermissions-userid-permissions)
  - [`admin.users.getGroups({ userId })`](#adminusersgetgroups-userid)
  - [`admin.users.addToGroup({ userId, groupId })`](#adminusersaddtogroup-userid-groupid)
  - [`admin.users.removeFromGroup({ userId, groupId })`](#adminusersremovefromgroup-userid-groupid)
- [Groups](#groups)
  - [`admin.groups.list()`](#admingroupslist)
  - [`admin.groups.create({ name, permissions })`](#admingroupscreate-name-permissions)
  - [`admin.groups.update({ id, name?, permissions? })`](#admingroupsupdate-id-name-permissions)
