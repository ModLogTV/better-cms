			...
			>
				<Popover open={showFieldSelector} onOpenChange={setShowFieldSelector}>
					<PopoverTrigger asChild>
						<Button
							variant="ghost"
							className="h-8 rounded-none rounded-l-md border border-input border-r-0 font-normal dark:bg-input/30"
						>
							{columnMeta?.icon && (
			...
			return (
				...
				>
					<SelectTrigger
						...
						className="h-full! rounded-none bg-transparent px-1.5 py-0.5 [&_svg]:hidden"
					>
