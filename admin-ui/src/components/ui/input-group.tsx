...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			// oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- shadcn primitive, styled as a div not a fieldset
			role="group"
			className={cn(
...
function InputGroupAddon({
	...
	return (
		// oxlint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-noninteractive-element-interactions -- onClick only refocuses a sibling input; it isn't itself interactive or tab-stopped, so it needs no key handler of its own
		<div
