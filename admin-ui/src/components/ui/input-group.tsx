...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: shadcn primitive, styled as a div not a fieldset
		<div
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: shadcn primitive, styled as a div not a fieldset
		// biome-ignore lint/a11y/useKeyWithClickEvents: onClick focuses a sibling input, not itself interactive/tab-stopped
		<div
